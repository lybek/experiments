...
public class SelectionGameActivityMedium extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selection_game_medium);
    ...
    public void saveHighScore(int score) {
        ...
        if (getIntent().hasExtra("name")) {
            ...
            highScore = sharedPreferences.getInt(name + "SelectionMed", 0);
        }

        if (score > highScore) {
            final SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putInt(name + "SelectionMed", score);
            editor.apply();
        }
    }
