...
public class PicGameActivity extends AppCompatActivity {

    public static final String MyPREFERENCES = "MyPrefs";
    SharedPreferences sharedPreferences;
    public static int[] pics = {R.drawable.janes, R.drawable.koer, R.drawable.karu,
            R.drawable.kass, R.drawable.lehm, R.drawable.siga, R.drawable.elevant,
            R.drawable.panda, R.drawable.joehobu, R.drawable.pingviin, R.drawable.pesukaru,
            R.drawable.kana, R.drawable.orav};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pic_game);
        isPressed = false;
